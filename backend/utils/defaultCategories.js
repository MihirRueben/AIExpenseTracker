...
export const defaultCategories = [
    ...
    { name: 'Investment', type: 'income', icon: 'chart-line', color: '#14B8A6' },
    { name: 'Gift', type: 'income', icon: 'gift', color: '#06B6D4' },
    { name: 'Other', type: 'income', icon: 'plus-circle', color: '#0EA5E9' },
